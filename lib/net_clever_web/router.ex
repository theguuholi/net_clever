defmodule NetCleverWeb.Router do
  use NetCleverWeb, :router

  import NetCleverWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {NetCleverWeb.LayoutView, :root}
